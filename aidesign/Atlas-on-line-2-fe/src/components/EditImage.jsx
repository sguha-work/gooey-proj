...
const EditImage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://212.64.220.94:3000/edit-image",
        formData,
        {
  ...
  return (
    <div className="text-gray-800 font-jost">
      ...
      <main className="main">
        <section className="pt-10 relative flex items-center text-white">
          <div className="container mx-auto px-4 relative">
            <div className="flex flex-col justify-center items-center gap-y-10 mx-auto lg:max-w-xl max-w-3xl w-full">
              <div className="2xl:max-w-[862px] xl:max-w-[768px] max-w-[768px] px-4 text-center">
              
                <div className="xl:mt-8 flex flex-col items-center gap-y-6 text-white [&_h1]:capitalize [&_h1_strong]:font-semibold [&_h1_strong]:bg-gradient-to-r [&_h1_strong]:from-purple-400 [&_h1_strong]:via-pink-500 [&_h1_strong]:to-red-500 [&_h1_strong]:bg-clip-text [&_h1_strong]:text-transparent [&_p]:text-lg [&_p]:font-light text-center">
                  <h1 className="xl:text-[45px] lg:text-4xl text-3xl font-semibold leading-tight">
                    Image Editing <strong>Tool</strong>
                  </h1>
                ...
                <div className="flex flex-col gap-y-6">
                  ...
                  <div>
                    ...
                    <div className="w-full rounded-full bg-gray-800 bg-opacity-50 backdrop-blur-md">
                      <div className="block w-full rounded-full border-0 ring-1 ring-inset ring-[#EE4172] ring-opacity-40 xl:py-5 sm:py-4 py-2.5 pl-2.5 pr-16 text-lg text-white bg-transparent placeholder:text-gray-500 font-light focus:outline-0 focus:ring-1 focus:ring-inset focus:ring-purple-600 sm:leading-6 duration-150">
                        <span
                    ...
                    <div className="w-full rounded-full bg-gray-800 bg-opacity-50 backdrop-blur-md">
                      <div className="block w-full rounded-full border-0 ring-1 ring-inset ring-[#EE4172] ring-opacity-40 xl:py-5 sm:py-4 py-2.5 pl-2.5 pr-16 text-lg text-white bg-transparent placeholder:text-gray-500 font-light focus:outline-0 focus:ring-1 focus:ring-inset focus:ring-purple-600 sm:leading-6 duration-150">
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() => handleFileRemove("maskFile")}
                            className="inline-flex justify-center items-center w-4 h-4 ms-2 text-sm text-white bg-[#FF7CA1] rounded-full hover:bg-[#c55a78]"
                            data-dismiss-target="#badge-dismiss-default"
                            aria-label="Remove"
                          >
