...
const MainContent = () => {
  ...
  const handleSubmit = async (e, data = null) => {
    ...
    try {
      ...
      const res = await axios.post(`https://ainews.atlaschat.io:7111/api/chat`, {
        message: content,
      });
      ...
      <section className="site-bg hero-pad bubble-circle home-hero-section">
        <div className="container">
          <div className="text-center">
            ...
            <h1 className="home-hero-title wow fadeInUp mb-20" data-wow-delay=".3s">Worldwide AI News !</h1>
